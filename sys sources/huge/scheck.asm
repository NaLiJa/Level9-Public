...
GLFreadNext32K:
 ...
 push dx
 mov cx,4000h ;* 8000h               ;instead, load 32K bytes
 jmp short GLF02
...
AnotatePRS proc near
 ...
 mov ax,ds:OptionAnotate
 and ax,ds:WithinRange
 jne PRS
...
AllocateMemory proc near
 ...
 mov bx,(65535/16)+1        ;Request 64K bytes of memory
...
SetOptions proc near
 ...
 mov ds:OptionMaxCell,16382 ;Default - Max Object Number
 mov ds:OptionStart,0       ;Default - Lowest Object xref/verbose
 mov ds:OptionEnd,16382     ;Default - Last Object xref/verbose
...
SO03:
 call PRS
 db 13,10,"STRUCTUR.DAT must be in current directory"
 db 13,10
 db 13,10,"Try: SCHECK options"
 db 13,10,"           /e #  (End object for verbose)              default 16382"
 db 13,10,"           /h #  Set max raster height (in cells)      default 13"
 db 13,10,"           /l #  Set max Object Length (in bytes)      default 512"
 db 13,10,"           /m #  Set max cell number                   default 16382"
 db 13,10,"           /o    report truncated animation sequences "
 db 13,10,"           /p    Verify unused (padder) bytes are zero"
 db 13,10,"           /s #  (Start object for verbose)            default 1"
 db 13,10,"           /v    Verbose                              "
 db 13,10,"           /w #  Set raster width (in cells)           default 22"
 db 13,10,"$"
...
SO14Z:                      ;parse /m # Set max cell
 call ParseNumber
 mov ds:OptionMaxCell,ax
 jmp SO11
...
SO15A:                      ;parse /s # Set start object
 call ParseNumber
 mov ds:OptionStart,ax
 jmp SO11
...
SetInSideRange proc near

 mov ax,ds:CurrentObject
 cmp ax,ds:OptionEnd
 ja RangeOn                ;beyond 'end'
 cmp ax,ds:OptionStart
 jb RangeOn                ;Before 'start'
 mov ds:WithinRange,1      ;Between 'start' end 'end'
 ret
RangeOn:
 mov ds:WithinRange,0
 ret
...
CopyRight proc near
 ...
 call PRS
 db 13,10,"SCHECK V0.1"
 db 13,10,"Copyright (C) 23/10/1989 Level 9 Computing"
 db 13,10,"$"
 ret
...
OptionStart       dw 0      ;Object number to start output
OptionEnd         dw 0      ;Object number to stop output
vars ends
